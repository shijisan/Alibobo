            ...
            <form className="flex flex-col justify-center w-full p-5 bg-white rounded-2xl lg:w-1/3">
                ...
                <div className="flex gap-3 mt-8 input-group">
                    ...
                    <div id="firstName" className="lg:w-1/2"> 
                        ...
                        <input className="w-full p-2 border rounded-lg border-blue-950" type="text" name="firstName" id="firstName" />
                    </div>

                    <div id="lastName" className="lg:w-1/2">
                        <label className="my-2" htmlFor="lastName">Last Name:</label>
                        <input className="w-full p-2 border rounded-lg border-blue-950" type="text" name="lastName" id="lastName" />
                    </div>
